  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
		...
		<?php if(is_array($newslist)): foreach($newslist as $key=>$value): ?><tr>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['id']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['name']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['news_class']['c_name']); ?></td>
