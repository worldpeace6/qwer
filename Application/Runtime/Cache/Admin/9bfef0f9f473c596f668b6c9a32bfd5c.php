  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
			...
			<th style="text-align:left; padding-left:20px;">名称</th>
			<th>操作</th>
      </tr>
      
        
		<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr data-tt-id="<?php echo ($value['id']); ?>" data-tt-parent-id="<?php echo ($value['pid']); ?>">
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['id']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['cate_name']); ?></td>
