  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
			...
			<th style="text-align:left; padding-left:20px;">商品主图</th>
		...
		<?php if(is_array($goodslist)): foreach($goodslist as $key=>$value): ?><tr>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['id']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['goods_name']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['category']['cate_name']); ?></td>
			<td style="text-align:left; padding-left:20px;"><?php echo ($value['brand']['brand_name']); ?></td>
			<td style="text-align:left; padding-left:20px;"><img src="/<?php echo ($value['image']); ?>" height='100'></td>
