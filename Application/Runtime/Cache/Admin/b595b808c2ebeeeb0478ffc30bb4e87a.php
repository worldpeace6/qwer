...
<div class="leftnav">
  ...
  <ul style="display:block">
	...
	<li><a href="<?php echo U('Spec/index');?>" target="right"><span class="icon-caret-right"></span>商品规格</a></li>   
  </ul>
  ...
  <ul>
    ...
    <li><a href="<?php echo U('NewsType/index');?>" target="right"><span class="icon-caret-right"></span>分类管理</a></li>
  </ul> 

  <h2><span class="icon-pencil-square-o"></span>RBAC管理</h2>
  <ul>
...
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="<?php echo U('welcom');?>" name="right" width="100%" height="100%"></iframe>
</div>
